...
class AuBirthCertScreen extends StatefulWidget {
  const AuBirthCertScreen({super.key});
  @override
  State<AuBirthCertScreen> createState() => _AuBirthCertScreenState();
}

class _AuBirthCertScreenState extends State<AuBirthCertScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    final provider = context.read<Verification>();
    final success = await provider.submitAuBirthCertData(
      context,
    ...
    return Form(
      ...
      child: ListView(
        ...
        children: [
          ...
          _buildDropdown(),
          _buildDateField(controller: _regDateController, label: 'Registration Date (Optional)'),
          _buildTextField(
          ...
          _buildTextField(controller: _certNumController, label: 'Certificate Number (Optional)'),
          _buildDateField(controller: _datePrintedController, label: 'Date Printed (Optional)'),
  ...
  Widget _buildTextField(
      {required TextEditingController controller, required String label, TextInputType? keyboardType, List<TextInputFormatter>? formatters}) {
    return Padding(
