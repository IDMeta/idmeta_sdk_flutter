...
class AuMarriageCertScreen extends StatefulWidget {
  const AuMarriageCertScreen({super.key});
  @override
  State<AuMarriageCertScreen> createState() => _AuMarriageCertScreenState();
}

class _AuMarriageCertScreenState extends State<AuMarriageCertScreen> {
  final _formKey = GlobalKey<FormState>();
  final _brideFamilyController = TextEditingController();
  final _brideGivenController = TextEditingController();
  final _groomFamilyController = TextEditingController();
  final _groomGivenController = TextEditingController();
  ...
  @override
  void dispose() {
    _brideFamilyController.dispose();
    _brideGivenController.dispose();
    _groomFamilyController.dispose();
    _groomGivenController.dispose();
  ...
  Future<void> _submitForm() async {
    ...
    final success = await provider.submitAuMarriageCertData(
      context,
      brideFamilyName: _brideFamilyController.text,
      brideGivenName: _brideGivenController.text,
      groomFamilyName: _groomFamilyController.text,
      groomGivenName: _groomGivenController.text,
      dob: _marriageDateController.text, // DOB field in API is used for Marriage Date here
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: ListView(
        ...
        children: [
          _buildTextField(controller: _brideFamilyController, label: 'Bride Family Name*'),
          _buildTextField(controller: _brideGivenController, label: 'Bride Given Name*'),
          _buildTextField(controller: _groomFamilyController, label: 'Groom Family Name*'),
          _buildTextField(controller: _groomGivenController, label: 'Groom Given Name*'),
          _buildDateField(controller: _marriageDateController, label: 'Date of Marriage*'),
